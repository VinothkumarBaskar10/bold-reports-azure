ej.ReportDesigner.Locale['en-CA'] = {
    itemPanel: {
    ...
    dataSource: {
        ...
        elasticSearchDatasource: {
            ...
            noteMessage: {
                note: 'Note: ',
                message: 'To connect to an Amazon Web Service hosted Elasticsearch instance, please use the Open Distro Connection Type.'
            }
        },
    ...
    expression: {
        ...
        description: {
            ...
            stringLength: 'Returns an integer containing either the number of characters in a string or the number of bytes required to store a variable.',
            ...
            depthLevel: 'Returns a zero-based integer representing the current depth level of a recursive hierarchy.',
    ...
    dataAssign: {
        ...
        warningMessage: {
            title: 'Data Assign',
            contentMessage: 'Adding more than 5 {categoryName} will cause rendering delay. Would you like to add anyway ?'
        }
    },
    reportProperty: {
        header: 'Header',
    ...
    mapProperty: {
        ...
        basicSettings: {
            categoryName: 'Basic Settings',
            polygonLayerName: 'Polygon Layer Name',
            shapeType: 'Shapes',
            datasetName: 'Dataset',
