ej.ReportDesigner.Locale['zh-CN'] = {
    ...
    expression: {
        ...
        description: {
            ...
            isDate: '傳回布林值，指示表達式是否表示有效的日期值',
            isNothing: '傳回布林值，指示表達式是否沒有指派給它的對象',
            ...
            depthLevel: '傳回一個從零開始的整數，表示遞歸層次結構的當前深度級別.',
